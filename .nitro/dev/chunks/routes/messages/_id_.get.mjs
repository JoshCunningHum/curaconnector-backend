...
import { and, or, eq, lt, desc } from 'file://D:/Documents/WebsitesPrograms/Work/Axel/backend/node_modules/.pnpm/drizzle-orm@0.44.2_@types+b_8a624cc9ffd98e02c10a3d5dfc6bcc4d/node_modules/drizzle-orm/index.js';
import { e as db } from '../../_/nitro.mjs';
import { m as messages } from '../../_/message.mjs';
import { a as validateQuery } from '../../_/validateBody.mjs';
...
const _id__get = defineEventHandler(async (event) => {
  ...
  const messageList = await db.select().from(messages).where(
    and(
      ...
      query.cursor ? lt(messages.id, query.cursor) : void 0
    )
  ).orderBy(desc(messages.createdAt)).limit(query.limit);
  let nextCursor = null;
