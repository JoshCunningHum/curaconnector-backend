...
import { e as db, l as locationSharing } from '../_/nitro.mjs';
...
const gpsInitiate_post = defineEventHandler(async (event) => {
...
export { gpsInitiate_post as default };
//# sourceMappingURL=gps-initiate.post.mjs.map
